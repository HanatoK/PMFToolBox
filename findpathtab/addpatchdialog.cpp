...
QString AddPatchDialog::center() const
{
  return mCenterText->text();
}
...
double AddPatchDialog::value() const
{
  return mValueText->text().toDouble();
}

size_t AddPatchDialog::dimension() const
{
  return mDimension;
}

void AddPatchDialog::setDimension(int dimension)
{
